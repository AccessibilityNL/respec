...
const nl = {
  ...
  implementationReport: "Implementatie rapport",
  ...
  return tests
    .map(test => {
      try {
        ...
        pub("warn", `${l10n$c[lang$j].bad_uri}: ${test}`);
      }
    })
    .filter(href => href);
}
